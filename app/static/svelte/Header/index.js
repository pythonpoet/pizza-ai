    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file, 14, 20, 275);
    			add_location(span, file, 14, 8, 263);
    			attr_dev(div0, "class", "user-bio svelte-gewy4u");
    			add_location(div0, file, 13, 6, 231);
    			...
    			add_location(img, file, 17, 8, 347);
    			add_location(div1, file, 16, 6, 332);
    			attr_dev(div2, "class", "user-info svelte-gewy4u");
    			add_location(div2, file, 12, 4, 200);
    			attr_dev(button, "class", "signout-button");
    			add_location(button, file, 20, 4, 468);
    		},
    		m: function mount(target, anchor) {
