...
var LoginApp = (function () {
    ...
    const file = "app\\svelte\\Login\\App.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file, 21, 2, 346);
    			attr_dev(input0, "name", "username");
    			attr_dev(input0, "minlength", "3");
    			attr_dev(input0, "maxlength", "16");
    			add_location(input0, file, 22, 2, 388);
    			attr_dev(label1, "for", "password");
    			add_location(label1, file, 24, 2, 472);
    			attr_dev(input1, "name", "password");
    			attr_dev(input1, "type", "password");
    			add_location(input1, file, 25, 2, 514);
    			attr_dev(button0, "class", "login");
    			add_location(button0, file, 27, 2, 585);
    			attr_dev(button1, "class", "login");
    			add_location(button1, file, 28, 2, 642);
    		},
